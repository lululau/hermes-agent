...
async def _send_to_platform(platform, pconfig, chat_id, message, thread_id=None, media_files=None, force_document=False):
    ...
    if media_files and not message.strip() and platform in _text_only_platforms:
        return {
            "error": (
                f"send_message MEDIA delivery is currently only supported for telegram, discord, matrix, weixin, signal, yuanbao, feishu, whatsapp, slack and plugin platforms with send_media; "
    ...
    if media_files and platform in _text_only_platforms:
        warning = (
            ...
            "native send_message media delivery is currently only supported for telegram, discord, matrix, weixin, signal, yuanbao, feishu, whatsapp, slack and plugin platforms with send_media"
        )
